...
function decalleImages(newMainImage, sens) {
    let divs= document.querySelectorAll('section.images div');
     ...
     setTimeout(function(){
         ...
         divGauche.className = "leftmain side";
         divDroite.className = "rightmain side";
 ...
 function animateEl(sens)
{
    ...
    let sided = document.querySelectorAll('.side');
    sided.forEach(function(el){
